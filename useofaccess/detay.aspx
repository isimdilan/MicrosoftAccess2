<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="detay.aspx.cs" Inherits="_Default" %>
...
var mygallery=new simpleGallery({
	...
	imagearray: [
		["<%Response.Write(GridView1.Rows[GridView1.Rows.Count-4].Cells[2].Text); %>", "detay.aspx?no=<%Response.Write(GridView1.Rows[GridView1.Rows.Count-4].Cells[0].Text); %>", "_new", ""],
		["<%Response.Write(GridView1.Rows[GridView1.Rows.Count-3].Cells[2].Text); %>", "detay.aspx?no=<%Response.Write(GridView1.Rows[GridView1.Rows.Count-3].Cells[0].Text); %>", "_new", ""],
		["<%Response.Write(GridView1.Rows[GridView1.Rows.Count-2].Cells[2].Text); %>", "detay.aspx?no=<%Response.Write(GridView1.Rows[GridView1.Rows.Count-2].Cells[0].Text); %>", "_new", ""],
		["<%Response.Write(GridView1.Rows[GridView1.Rows.Count-1].Cells[2].Text); %>", "detay.aspx?no=<%Response.Write(GridView1.Rows[GridView1.Rows.Count-1].Cells[0].Text); %>", "_new", ""]
	],
...
var MenuBar1 = new Spry.Widget.MenuBar("MenuBar1", {imgDown:"SpryAssets/SpryMenuBarDownHover.gif", imgRight:"SpryAssets/SpryMenuBarRightHover.gif"});
        ...
        <tr>
            <td height="607" width="1000">
                <table align="center" cellpadding="0" cellspacing="0" 
                    style="width: 612px; height: 376px">
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Image ID="Image1" runat="server" Height="139px" Width="167px" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" ForeColor="White" Text="Özet"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <asp:Label ID="Label3" runat="server" ForeColor="White" Text="İçerik"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
            ...
            SelectCommand="SELECT * FROM [Table1] WHERE ([Kimlik] = ?)" 
            
        UpdateCommand="UPDATE [Table1] SET [baslik] = ?, [resim] = ?, [ozet] = ?, [icerik] = ? WHERE [Kimlik] = ?">
            <SelectParameters>
                <asp:QueryStringParameter Name="Kimlik" QueryStringField="no" Type="Int32" />
            </SelectParameters>
            <DeleteParameters>
