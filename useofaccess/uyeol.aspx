<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="uyeol.aspx.cs" Inherits="_Default" %>
        ...
        <tr>
            <td height="607" width="1000">
                <table align="center" cellpadding="0" cellspacing="0" 
                    style="height: 446px; width: 636px">
                    <tr>
                        <td class="style1">
                            Ad Soyad:</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                ControlToValidate="TextBox3" ErrorMessage="Zorunlu Alandır"></asp:RequiredFieldValidator>
&nbsp;
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                ...
                                ErrorMessage="Eşleşmiyor"></asp:CompareValidator>
                        </td>
                    </tr>
                    <tr>
                        <td class="style1">
        ...
        UpdateCommand="UPDATE [uyeol] SET [ad_soyad] = ?, [d_yeri] = ?, [sifre] = ? WHERE [kul_adi] = ?">
            ...
            <InsertParameters>
                ...
                <asp:ControlParameter ControlID="TextBox2" Name="d_yeri" PropertyName="Text" 
                    Type="String" />
                <asp:ControlParameter ControlID="TextBox3" Name="kul_adi" PropertyName="Text" 
                    Type="String" />
