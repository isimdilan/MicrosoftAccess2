<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="uyegirisi.aspx.cs" Inherits="_Default" %>
...
var MenuBar1 = new Spry.Widget.MenuBar("MenuBar1", {imgDown:"SpryAssets/SpryMenuBarDownHover.gif", imgRight:"SpryAssets/SpryMenuBarRightHover.gif"});
        ...
        <tr>
            <td height="607" width="1000">
                <table align="center" cellpadding="0" cellspacing="0" 
                    style="height: 383px; width: 613px">
                    <tr>
                        <td class="style1">
                            Kullanıcı Adı:</td>
                        <td>
        ...
        <p>
            <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                ...
                InsertCommand="INSERT INTO [uyeol] ( [kul_adi], [sifre]) VALUES ( ?, ?)" 
                ...
                <InsertParameters>
                    <asp:ControlParameter ControlID="TextBox1" Name="kul_adi" PropertyName="Text" 
                        Type="String" />
