<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="sifredegistir.aspx.cs" Inherits="_Default" %>
...
var MenuBar1 = new Spry.Widget.MenuBar("MenuBar1", {imgDown:"SpryAssets/SpryMenuBarDownHover.gif", imgRight:"SpryAssets/SpryMenuBarRightHover.gif"});
        ...
        <tr>
            <td height="607" width="1000">
                <table align="center" cellpadding="0" cellspacing="0" 
                    style="width: 571px; height: 413px">
                    <tr>
                        <td class="style1">
        ...
        <p>
            <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
                ...
                UpdateCommand="UPDATE [uyeol] SET  [sifre] = ? WHERE [kul_adi] = ?">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="o_durumu" Type="String" />
                </InsertParameters>
